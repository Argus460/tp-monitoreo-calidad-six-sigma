...
class Reporte:
    def __init__(self, muestra, lote, profesional, fecha: datetime, causas: list):
...
class Equipo:
    ...
    categorias=[]
    equipos = []
    def __init__(self, nombre, ult_calibracion, categoria):
...
class Profesional:
    ...
    counter = 1
    def __init__(self, nombre, certificados):
...
class Procedimiento:
    ...
    counter=1
    def __init__(self,nombre,certificaciones,criterio,pasos, categoria, gravedad_max:int): 
        try :
            self.nombre=nombre
...
class Muestra:
    ...
    contador=1
    defecto=[]
    def __init__(self, cantidad, lote_asociado, estado):
